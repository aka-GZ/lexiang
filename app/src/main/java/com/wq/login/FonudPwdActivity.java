...
//	@Bind(R.value.lab_icon1) ImageView lab_icon1;
//	@Bind(R.value.lab_icon2) ImageView lab_icon2;
	...
	// @Bind(title = R.value.pageName) TextView pageName;
	// @Bind(R.value.headBg) ConcentricCircle headBg;
	int time = 60;
	String code_id;
...
//		BaseQuestStart.updateUserPassword(this, account,pwd, captcha);
	}
...
//			BaseQuestStart.captchaForfoundPwd(this, account);
		}
	}
